        ...
        return (
            <View style = {styles.container}>
                <ImageBackground
                    source={
                        this.state.score < 20 ?
                            require('../assets/GameOver/Dirtyworld.png')
                        :
                        this.state.score >= 20 && this.state.score < 50 ?
                            require('../assets/GameOver/Mediumworld.png')
                        :
                            require('../assets/GameOver/Cleanworld.png')
                        }
                    style={{
                        width: "100%",
                        height: "100%"
                ...
                >
                    <Pressable 
                        style = {[styles.button, {position: 'absolution', top: 40, right: 20, borderRadius: 5, width: 120, backgroundColor: '#001E6C'}]}
                    ...
                    <View style={styles.info_container}>
                        ...
                        <Text style={[styles.faceText, {color: this.state.score < 20 && 'white'}]}>Temporary fun fact</Text>
                    </View>
                ...
                <Modal 
                    ...
                    onBackdropPresss={Keyboard.dismiss}
                >
